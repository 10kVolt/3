...
twitch_miner = TwitchChannelPointsMiner(
    username="uranium57",
    password="tukan4850",           # If no password will be provided, the script will ask interactively
...
twitch_miner.mine(
    [
       ...
       Streamer("Recrent", settings=StreamerSettings(make_predictions=True  , follow_raid=True , claim_drops=True  , watch_streak=True , bet=BetSettings(strategy=Strategy.SMART      , percentage=5 , stealth_mode=True,  percentage_gap=20 , max_points=2000   , filter_condition=FilterCondition(by=OutcomeKeys.TOTAL_USERS,      where=Condition.LTE, value=800 ) ) )),
